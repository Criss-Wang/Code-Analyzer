...
static void InitializePkb() {
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 1, "0");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 2, "0");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 3, "0");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 5, "count + 1");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 6, "cenX + x");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 7, "cenY + y");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 9, "1");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 10, "cenX / count");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 11, "cenY / count");
    ...
    pkb.AddInfoToTable(TableIdentifier::kAssignPattern, 12, "cenX * cenX + cenY * cenY");
